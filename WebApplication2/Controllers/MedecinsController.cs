...
namespace WebApplication2.Controllers
{
    public class MedecinsController : Controller
    {
        ...
        public MedecinsController(CovidContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,medecinName,email,phone,speciality")] Medecin medecin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,medecinName,email,phone,speciality")] Medecin medecin)
        {
            if (id != medecin.ID)
            {
                return NotFound();
